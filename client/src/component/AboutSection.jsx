...
const AboutSection = () => (
  <div className="min-h-screen text-white font-sans px-4 py-12 flex flex-col items-center lg:items-start">
    {/* Heading */}
    <div className="mt-2 ">
      <h1 className="text-4xl md:text-6xl font-extrabold mb-2 md:mb-0 text-center md:text-left mt-2 md:ml-24 lg:ml-70">
        About
      </h1>
    </div>
    ...
    <div className="flex flex-col lg:flex-row items-center justify-center gap-8 md:gap-16 w-full">
      {/* Left Card */}
      <div className="bg-gradient-to-br from-[#23222b] to-[#23222b]/80 shadow-lg p-8 w-full max-w-xs md:max-w-sm flex flex-col justify-between min-h-[220px] md:ml-24 text-center md:text-left lg:mr-50">
      ...
      <div className="flex flex-col lg:flex-row items-center gap-4">
        <img src="/box1.png" alt="Box 1" className="w-40 md:w-48 lg:w-70" />
        <img src="/box1.png" alt="Box 2" className="w-40 md:w-48 lg:w-70" />
      </div>
    </div>
  </div>
);
