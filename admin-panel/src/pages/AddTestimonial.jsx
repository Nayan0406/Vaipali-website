...
const AddTestimonial = () => {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4 max-w-lg mx-auto p-4 bg-gray-800 text-white mt-20">
      <input name="name" value={formData.name} onChange={handleChange} placeholder="Client Name" className="w-full p-2 border" />
      <input name="owner" value={formData.owner} onChange={handleChange} placeholder="Owner of (company/project)" className="w-full p-2 border" />
      <input name="rating" type="number" value={formData.rating} onChange={handleChange} placeholder="Rating (1-5)" className="w-full p-2 border" min="1" max="5" />
